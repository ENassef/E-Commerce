...
export default function Card({ product }) {
    ...
    async function handleAddToCart(productId) {
        return toast.promise(addItemToCart(productId), {
    ...
    async function handleAddToWishList(productId) {
        return toast.promise(addToWishList(productId), {
    ...
    return (
        ...
        >
            {/* Product Image with Hover Actions (Desktop) */}
            <header className="relative selection:bg-white/0">
                ...
                <div className="layer -translate-y-1/2 hidden md:flex justify-center items-center gap-4 absolute top-1/2 left-1/2 -translate-x-1/2">
                    <div
            ...
            <footer className="py-4 px-5">
                ...
                {/* Footer with always-visible mobile buttons */}
                <footer className="flex flex-col sm:flex-row justify-between mt-3 items-center gap-3 sm:gap-0">
                    ...
                    <div className="flex md:hidden justify-center items-center gap-4">
                        <div
                            onClick={() => handleAddToWishList(product.id)}
                            className="cursor-pointer bg-primary flex justify-center items-center size-10 bg-opacity-70 rounded-full text-maincolor"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
